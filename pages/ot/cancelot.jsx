...
export default function CalendarPage(props) {
    ...
    async function handleCancelOT() {
        ...
        waiting.map(data => {
            ...
            // console.log(actionStartDate, waitingStartDate);
            // console.log(actionEndDate, waitingEndDate);
        ...
        if (check) {
            let PostData = await addWaitingApproveToFirebase('Cancel OT', 'Cancel OT', state.id, state.name, stateDialog.start, stateDialog.end, 'Cancel OT', state.tier);
                ...
                <DialogActions>
                    <Button variant="outlined" onClick={handleClose}>Close</Button>
                    {
                        loadingButton ?
                            ...
                            :
                            <Button variant="outlined" color="error" onClick={() => handleCancelOT()}>Cancel OT</Button>
                    }
                </DialogActions>
